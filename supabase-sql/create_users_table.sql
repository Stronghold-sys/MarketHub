-- ============================================
-- MARKETHUB E-COMMERCE - USERS TABLE
-- ============================================
-- 
-- Run this SQL in Supabase SQL Editor to create users table
-- Dashboard: https://supabase.com/dashboard → Your Project → SQL Editor
--
-- This table stores all user accounts in a proper relational structure
-- alongside the KV store for dual storage benefits
-- ============================================

-- Drop table if exists (for development only - REMOVE IN PRODUCTION!)
-- DROP TABLE IF EXISTS users_adb995ba CASCADE;
