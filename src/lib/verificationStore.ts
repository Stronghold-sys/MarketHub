...
export const verificationStoreHelpers = {
  setVerificationData: (data: VerificationData | null) => {
    console.log('✅ [VerificationStore] Storing verification data:', {
      email: data?.email,
  ...
  clearVerificationData: () => {
    console.log('🗑️ [VerificationStore] Clearing verification data');
  ...
  isVerificationValid: (): boolean => {
    ...
    if (!isValid) {
      console.log('⏰ [VerificationStore] Verification data expired');
  ...
  setResetData: (data: ResetData | null) => {
    console.log('✅ [VerificationStore] Storing reset data:', {
      email: data?.email,
      timestamp: data?.timestamp,
    });
  ...
  clearResetData: () => {
    console.log('🗑️ [VerificationStore] Clearing reset data');
  ...
  isResetValid: (): boolean => {
    ...
    if (!isValid) {
      console.log('⏰ [VerificationStore] Reset data expired');
