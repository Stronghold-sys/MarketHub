      ...
      await runTest(
        ...
        async () => {
          ...
          if (response.status === 401) {
            console.log('ℹ️ [UserStatus] Token expired or invalid (expected)');
            return false;
          }
          ...
          if (response.status === 403) {
            ...
            if (errorData.banned) {
              console.log('ℹ️ [UserStatus] User is banned/suspended (expected)');
            } else if (errorData.deleted) {
              console.log('ℹ️ [UserStatus] User was deleted (expected)');
            } else {
              console.log('ℹ️ [UserStatus] User account inactive (expected)');
            }
            return false;
          }
