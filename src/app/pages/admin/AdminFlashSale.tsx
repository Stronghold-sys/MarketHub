...
export default function AdminFlashSale() {
  ...
  useEffect(() => {
    ...
    console.log('=== FLASH SALE FILTERING ===');
    console.log('📊 Total Products:', products.length);
    console.log('⚡ Flash Sale Products:', flashSale.length);
    console.log('📦 Other Products (available to add):', others.length);
    console.log('🔍 Flash Sale Product Details:', flashSale.map(p => ({ id: p.id, name: p.name, isFlashSale: p.isFlashSale })));
    console.log('🔍 Other Product Details:', others.map(p => ({ id: p.id, name: p.name, isFlashSale: p.isFlashSale })));
  }, [products]);
