...
export default function AdminProducts() {
  ...
  useEffect(() => {
    const syncProductsToBackend = async () => {
      ...
      console.log('🔄 Syncing all products to backend...');
      ...
      for (const product of storeProducts) {
        try {
          ...
          console.log(`✅ Synced: ${product.id}`);
        } catch (error) {
          console.error(`❌ Failed to sync: ${product.id}`, error);
        }
      }

      console.log('✅ All products synced to backend!');
    };
  ...
  */
  ...
  const handleAdd = async () => {
    try {
      ...
      if (accessToken) {
        console.log('📤 Saving product to backend:', newProduct.id);
  ...
  const handleEdit = async () => {
    ...
    try {
      ...
      if (accessToken) {
        console.log('📤 Updating product in backend:', selectedProduct.id);
