...
export default function AdminChat() {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      console.log('🔄 [AdminChat] Auto-refreshing conversations...');
      fetchConversations();
    }, 5000);
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      console.log('🔄 [AdminChat] Auto-refreshing messages...');
  ...
  const handleSelectConversation = async (conversationId: string) => {
    console.log('📍 [AdminChat] Selecting conversation:', conversationId);
  ...
  const handleSendMessage = async () => {
    ...
    console.log('💬 [AdminChat] Sending reply:', {
      conversationId: activeConversationId,
    ...
    try {
      ...
      setMessageInput('');
      console.log('✅ [AdminChat] Reply sent successfully');
  ...
  const handleRefresh = async () => {
    console.log('🔄 [AdminChat] Manual refresh...');
